...
2. **渠道安全**：不包含凭证、账号、Token、原始 MCP 载荷、许可证内容、客户原始日志、原始工单正文、评论或附件
3. **参考证据边界明确**：GitHub 源码参考、ZStack知识社区(BBS) 参考、BBS/Jira/Confluence 链接和外部 Web/厂商论坛参考必须标注"参考证据，非当前客户证据"
