...
| 技能 | 说明 |
|------|------|
| 事件分析 | 核心技能。先判断入口类型；低风险概念问题直接答，具体 ZStack 支持事件默认主动查 GitHub+BBS+Jira，涉及版本边界/标准口径时补查 Confluence；复杂事件输出 Intake、证据映射、参考证据、安全行动建议和闭环决策 |
