...
$internalKnowledgeFirst = U @(0x5185,0x90e8,0x77e5,0x8bc6,0x7cfb,0x7edf,0x4f18,0x5148,0x67e5,0x8bc1)
...
Assert-Contains $eventSkill ([regex]::Escape($internalKnowledgeFirst)) "event skill must keep internal-knowledge-first support workflow"
